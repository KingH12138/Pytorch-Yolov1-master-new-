...
def args_parse():
    ...
    parser.add_argument(
        '-imaged',
        type=str,
        default=r'D:\数据集\VOC2007\JPEGImages',
        help="The JPEGImage's directory",
    )
    parser.add_argument(
        '-infop',
        type=str,
        default=r'D:\PythonCodes\Pytorch-ObjectDetection-master\data\voc\refer.csv',
...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    for epoch in range(args.e):
        ...
        # train_table.add_row([epoch+1, valid_acc, valid_pre, valid_recall, valid_f1])
    ...
    #               [losses, accuracies, precisions, recalls, f1s], args.wd)
    log_generator(args.t, et - st, dataset_table, classes_table, device_table, train_table, optimizer, model, args.e,
                  [losses], args.wd)
# ----------------------------------------------------------------------------------------------------------------------
